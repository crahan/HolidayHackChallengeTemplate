...
This is the template I've used for my 2020, 2021, and 2022 SANS HHC submissions. It's based on [MkDocs](https://www.mkdocs.org) and the [MkDocs Material](https://squidfunk.github.io/mkdocs-material/) theme. Examples of winning reports and their associated repositories can be found at:
...
**IMPORTANT**: While the event is ongoing make sure to configure your forked GitHub repository as _Private_ so no solutions or spoilers are accidentally leaked to the public.
